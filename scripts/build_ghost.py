...
ref_root = f'{repo_root}/refs/frames/ghost'
relative_output = 'resources/skins/ghost.png'
output = f'{repo_root}/ragtimerumble/{relative_output}'
gamedata_output_path = f'{repo_root}/ragtimerumble/resources/animdata/ghost.json'
...
data = {
    ...
    'framesize': (64, 64),
    "center": [32, 55],
    'filepath': "resources/skins/ghost.png",
    'animations': {}
}
