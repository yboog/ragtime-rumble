...
ref_root = f'{repo_root}/refs/frames/saloon-door-a'
relative_output = 'resources/skins/saloon-door-a.png'
output = f'{repo_root}/ragtimerumble/{relative_output}'
gamedata_output_path = f'{repo_root}/ragtimerumble/resources/animdata/saloon-door-a.json'
...
data = {
    ...
    'y': -1000,
    'framesize': (181, 117),
    'filepath': "resources/skins/saloon-door-a.png",
    'animations': {}
}
