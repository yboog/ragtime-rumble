...
ref_root = f'{repo_root}/refs/frames/banjo'
relative_output = 'resources/skins/bango.png'
output = f'{repo_root}/ragtimerumble/{relative_output}'
gamedata_output_path = f'{repo_root}/ragtimerumble/resources/animdata/pianist.json'
...
data = {
    ...
    'y': -1000,
    'framesize': (25, 28),
    'filepath': "resources/skins/banjo.png",
    'animations': {}
}
