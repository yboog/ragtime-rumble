...
ref_root = f'{repo_root}/refs/frames/dogo/dogo'
relative_output = 'resources/skins/diego.png'
output = f'{repo_root}/ragtimerumble/{relative_output}'
gamedata_output_path = f'{repo_root}/ragtimerumble/resources/animdata/diego.json'
