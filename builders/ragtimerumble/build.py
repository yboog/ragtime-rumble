...
RAGTIMERUMBLE_ROOT = f'{HERE}/../../ragtimerumble'
...
executable_file = os.path.expandvars(f'{RAGTIMERUMBLE_ROOT}/ragtimerumble/__main__.py')
icon_file = os.path.expandvars(f'{RAGTIMERUMBLE_ROOT}/resources/ragtime.ico')
...
shutil.copytree(
    f'{RAGTIMERUMBLE_ROOT}/ragtimerumble',
    f'{lib_directory}/ragtimerumble')

shutil.copytree(
    f'{RAGTIMERUMBLE_ROOT}/resources',
